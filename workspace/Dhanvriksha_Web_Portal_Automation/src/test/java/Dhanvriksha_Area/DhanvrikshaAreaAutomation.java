 ...
 * </p>
 */
public class DhanvrikshaAreaAutomation  extends TestNameListener implements IReporter {
	
	public static WebDriver driver;
    private static final Logger LOG = Logger.getLogger(DhanvrikshaAreaAutomation.class);
...
@BeforeTest 
	...
	public static void setup()  throws InterruptedException, IOException  {
			...
			@Test (priority = 5)
	    			...
	    			public void Area_Module_Automation() throws InterruptedException	{
			        ...
			        Thread.sleep(10000);
	    	        WebElement area = driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[1]/div/div/div[2]/div/div[1]/div[2]/div/div/div/div[1]/ul/a[3]/div[2]"));
	    	        area.click();        
	    	        Thread.sleep(5000);
	    	        ...
	    	        Thread.sleep(2000);
	    	        driver.findElement(By.xpath("//*[@id=\"mui-5\"]")).sendKeys("Jai Shree Ram");
	    	        Thread.sleep(2000);
	    	        ...
	    	        System.out.println("---> Area Test Executed Successfully <---");
