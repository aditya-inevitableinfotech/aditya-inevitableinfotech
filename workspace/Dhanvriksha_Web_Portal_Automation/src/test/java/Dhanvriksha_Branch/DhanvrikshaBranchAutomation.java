 ...
 * </p>
 */
public class DhanvrikshaBranchAutomation  extends TestNameListener implements IReporter {
	
	public static WebDriver driver;
    private static final Logger LOG = Logger.getLogger(DhanvrikshaBranchAutomation.class);
...
@BeforeTest 
	...
	public static void setup()  throws InterruptedException, IOException  {
			...
			@Test (priority = 4)
	    			...
	    			public void Branch_Module_Automation() throws InterruptedException	{
			        ...
			        Thread.sleep(10000);	    	        
	    	        WebElement branch = driver.findElement(By.xpath("//div[contains(text(),'Branch')]"));
	    	        branch.click();	        
	    	        Thread.sleep(2000);
	    	        ...
	    	        Thread.sleep(5000);
	    	        driver.findElement(By.xpath("//*[@id=\"mui-5\"]")).sendKeys("Jai Shri Ram");
	    	        Thread.sleep(5000);
			        ...
			        System.out.println("---> Branch Test Excecuted Successfully <---");
			}
