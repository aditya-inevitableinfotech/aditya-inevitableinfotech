 ...
 * </p>
 */
public class DhanvrikshaMemberAutomation  extends TestNameListener implements IReporter {
	
	public static WebDriver driver;
    private static final Logger LOG = Logger.getLogger(DhanvrikshaMemberAutomation.class);
...
@BeforeTest 
	...
	public static void setup()  throws InterruptedException, IOException  {
			...
			@Test (priority = 9)
	    			...
	    			public void Member_Automation() throws InterruptedException	{
			        ...
			        Thread.sleep(10000);	    	        
	    	        WebElement member = driver.findElement(By.xpath("//div[contains(text(),'Members')]"));
	    	        member.click();
	    	        Thread.sleep(2000);
	    	        driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[2]/div/div/div[1]/a")).click();
	    	        Thread.sleep(2000);
	    	        driver.findElement(By.xpath("//*[@id=\"mui-12\"]")).sendKeys("Muskan(DNEMP003)");
	    	        Thread.sleep(2000);
	    	        driver.findElement(By.xpath("//*[@id=\"mui-12\"]")).click();
	    	        Thread.sleep(2000);
	    	        ...
	    	        Thread.sleep(2000);
	    	        driver.findElement(By.xpath("//*[@id=\"mui-10\"]")).sendKeys("17/11/1998");
	    	        Thread.sleep(2000);
	    	        ...
	    	        Thread.sleep(2000);
	    	        driver.findElement(By.xpath("//*[@id=\"mui-9\"]")).click();
	    	        Thread.sleep(2000); 
	    	        ...
	    	        System.out.println("---> Members Testing Executed Successfully <---");
