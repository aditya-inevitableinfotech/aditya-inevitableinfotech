 ...
 * </p>
 */
public class DhanvrikshaLoginAutomation  extends TestNameListener implements IReporter {
	
	public static WebDriver driver;
    private static final Logger LOG = Logger.getLogger(DhanvrikshaLoginAutomation.class);
...
@BeforeTest 
	...
	public static void setup()  throws InterruptedException, IOException  {
			...
			@Test (priority = 0)
	    	public void DhanvrikshaLoginTest() throws InterruptedException	{
