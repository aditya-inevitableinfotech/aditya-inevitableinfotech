 ...
 * </p>
 */
public class DhanvrikshaEmployeesAutomation  extends TestNameListener implements IReporter {
	
	public static WebDriver driver;
    private static final Logger LOG = Logger.getLogger(DhanvrikshaEmployeesAutomation.class);
...
@BeforeTest 
	...
	public static void setup()  throws InterruptedException, IOException  {
			...
			@Test (priority = 6)
	    			...
	    			public void Employees_Module_Automation() throws InterruptedException	{
			        ...
			        Thread.sleep(10000);	    	        
	    	        WebElement employee = driver.findElement(By.xpath("//div[contains(text(),'Employees')]"));
	    	        employee.click();
	    	        Thread.sleep(2000);	        
	    	        ...
	    	        Thread.sleep(2000);
	    	        driver.findElement(By.xpath("//*[@id=\"mui-4\"]")).sendKeys("aditya@inevitableinfotech.com");
	    	        Thread.sleep(2000); 
	    	        String typedText = driver.findElement(By.xpath("//*[@id=\"mui-6\"]")).getAttribute("Dhanvriskha Admin(DNEMP001)");
	    	        Thread.sleep(2000);
	    	        driver.findElement(By.xpath("//*[@id=\"mui-6\"]")).click();
	    	        Thread.sleep(2000);
	    	        driver.findElement(By.xpath("//*[@id=\"mui-6\"]")).sendKeys("Dhanvriskha Admin(DNEMP001)");
	    	        Thread.sleep(5000);
	    	        driver.findElement(By.xpath("//*[@id=\"mui-6\"]")).click();
	    	        Thread.sleep(2000);
	    	        ...
	    	        System.out.println("---> Employees Test Executed Successfully <---");
