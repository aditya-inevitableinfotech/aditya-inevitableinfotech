package Dhanvriksha_CollectionSheet;
 ...
 * </p>
 */
public class DhanvrikshaCollectionSheetAutomation  extends TestNameListener implements IReporter {
	
	public static WebDriver driver;
    private static final Logger LOG = Logger.getLogger(DhanvrikshaCollectionSheetAutomation.class);
...
@BeforeTest 
	...
	public static void setup()  throws InterruptedException, IOException  {
			...
			@Test (priority = 10)
	    			...
	    			public void Collection_Sheet_Automation() throws InterruptedException	{
			        ...
			        Thread.sleep(10000);	    	        
	    	        WebElement collectionSheet = driver.findElement(By.xpath("//div[contains(text(),'Collection Sheet')]"));
	    	        collectionSheet.click();
	    	        Thread.sleep(2000);
	    	        ...
	    	        Thread.sleep(2000);
	    	        driver.findElement(By.xpath("//*[@id=\"mui-4\"]")).sendKeys("14/11/2022");
	    	        Thread.sleep(2000);
	    	        driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[2]/div/div/form/div/div/div[1]/div/div[5]/button")).click();
	    	        Thread.sleep(2000);
	    	        
	    	        System.out.println("---> Collection Sheet Test Executed Successfully <---");
