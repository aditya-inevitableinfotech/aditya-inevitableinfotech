 ...
 * </p>
 */
public class DhanvrikshaReportsAutomation  extends TestNameListener implements IReporter {
	
	public static WebDriver driver;
    private static final Logger LOG = Logger.getLogger(DhanvrikshaReportsAutomation.class);
...
@BeforeTest 
	...
	public static void setup()  throws InterruptedException, IOException  {
			...
			@Test (priority = 10)
	    			...
	    			public void Logout_Automation() throws InterruptedException	{
	    	        ...
	    	        Thread.sleep(5000);
	    	        WebElement reports = driver.findElement(By.xpath("//div[contains(text(),'Reports')]"));reports.click();
	    	        Thread.sleep(2000);
			        driver.findElement(By.xpath("//*[@id=\"mui-4\"]")).sendKeys("14/11/2022");
	    	        Thread.sleep(5000);
	    			System.out.println("--------> Reports Test Executed Successfully on Chrome Browser <--------");
