package Dhanvriksha_RecurringDeposit;
 ...
 * </p>
 */
public class DhanvrikshaRecurringDepositAutomation  extends TestNameListener implements IReporter {
	
	public static WebDriver driver;
    private static final Logger LOG = Logger.getLogger(DhanvrikshaRecurringDepositAutomation.class);
...
@BeforeTest 
	...
	public static void setup()  throws InterruptedException, IOException  {
			...
			@Test (priority = 9)
	    			...
	    			public void Recurring_Deposit_Automation() throws InterruptedException	{
			        ...
			        Thread.sleep(10000);
	    	        WebElement rd = driver.findElement(By.xpath("//div[contains(text(),'Recurring Deposit')]"));
	    	        rd.click();
	    	        Thread.sleep(5000);
	    	        ...
	    	        Thread.sleep(2000);
	    	        driver.findElement(By.xpath("//*[@id=\"mui-15\"]")).sendKeys("Muskan(DNEMP003)");
	    	        Thread.sleep(2000);
	    	        driver.findElement(By.xpath("//*[@id=\"mui-15\"]")).click();
	    	        Thread.sleep(2000);
	    	        ...
	    	        Thread.sleep(2000);   
	    	        driver.findElement(By.xpath("//*[@id=\"mui-13\"]")).click();
	    	        Thread.sleep(2000);
	    	        driver.findElement(By.xpath("//*[@id=\"mui-13\"]")).sendKeys("17/11/1998");
	    	        Thread.sleep(2000);
	    	        ...
	    	        Thread.sleep(5000);
	    	        driver.findElement(By.xpath("//*[@id=\"mui-11\"]")).click();
	    	        Thread.sleep(2000); 
	    	        driver.findElement(By.xpath("//*[@id=\"mui-10\"]")).click();
	    	        Thread.sleep(5000);
	    	        ...
	    	        System.out.println("---> Recurring Deposit Test Executed Successfully <---");
