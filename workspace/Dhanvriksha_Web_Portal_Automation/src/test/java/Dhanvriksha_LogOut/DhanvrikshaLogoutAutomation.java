 ...
 * </p>
 */
public class DhanvrikshaLogoutAutomation  extends TestNameListener implements IReporter {
	
	public static WebDriver driver;
    private static final Logger LOG = Logger.getLogger(DhanvrikshaLogoutAutomation.class);
