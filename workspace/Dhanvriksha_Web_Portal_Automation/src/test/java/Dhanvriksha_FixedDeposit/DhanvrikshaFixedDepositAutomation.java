package Dhanvriksha_FixedDeposit;
 ...
 * </p>
 */
public class DhanvrikshaFixedDepositAutomation  extends TestNameListener implements IReporter {
	
	public static WebDriver driver;
    private static final Logger LOG = Logger.getLogger(DhanvrikshaFixedDepositAutomation.class);
...
@BeforeTest 
	...
	public static void setup()  throws InterruptedException, IOException  {
			...
			@Test (priority = 8)
	    			...
	    			public void Loans_Module_Automation() throws InterruptedException	{
			        ...
			        Thread.sleep(10000);
	    	        WebElement fd = driver.findElement(By.xpath("//div[contains(text(),'Fixed Deposit')]"));fd.click();
	    	        Thread.sleep(5000);
	    	        ...
	    	        System.out.println("---> Fixed Deposit Test Executed Successfully <---");
