 ...
 * </p>
 */
public class DhanvrikshaCollectionEntryAutomation  extends TestNameListener implements IReporter {
	
	public static WebDriver driver;
    private static final Logger LOG = Logger.getLogger(DhanvrikshaCollectionEntryAutomation.class);
...
@BeforeTest 
	...
	public static void setup()  throws InterruptedException, IOException  {
			...
			@Test (priority = 10)
	    			...
	    			public void Collection_Entry_Automation() throws InterruptedException	{
			        ...
			        Thread.sleep(10000);	    	        
	    	        WebElement collectionEntry = driver.findElement(By.xpath("//div[contains(text(),'Collection Entry')]"));
	    	        collectionEntry.click();
	    	        Thread.sleep(3000);
	    	        driver.findElement(By.xpath("//*[@id=\"mui-6\"]")).click();
	    	        Thread.sleep(2000);
	    	        driver.findElement(By.xpath("//*[@id=\"mui-6\"]")).sendKeys("R362190001");
	    	        Thread.sleep(2000);
	    	        ...
	    	        System.out.println("---> Collection Entry Test Executed Successfully <---");
