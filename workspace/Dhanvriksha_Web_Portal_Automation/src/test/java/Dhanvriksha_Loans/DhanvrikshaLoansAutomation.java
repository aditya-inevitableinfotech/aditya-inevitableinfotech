 ...
 * </p>
 */
public class DhanvrikshaLoansAutomation  extends TestNameListener implements IReporter {
	
	public static WebDriver driver;
    private static final Logger LOG = Logger.getLogger(DhanvrikshaLoansAutomation.class);
...
@BeforeTest 
	...
	public static void setup()  throws InterruptedException, IOException  {
			...
			@Test (priority = 7)
			        ...
			        Thread.sleep(10000);	    	        
	    	        WebElement loan = driver.findElement(By.xpath("//div[contains(text(),'Loans')]"));
	    	        loan.click();	        
	    	        Thread.sleep(5000);
	    	        ...
	    	        System.out.println("---> Loans Testing Executed Successfully <---");
