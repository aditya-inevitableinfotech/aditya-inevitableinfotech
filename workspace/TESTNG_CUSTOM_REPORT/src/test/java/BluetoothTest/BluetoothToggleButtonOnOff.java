 ...
 * </p>
 */
public class BluetoothToggleButtonOnOff implements IReporter {
    ...
    private static final Logger LOG = Logger.getLogger(BluetoothToggleButtonOnOff.class);
	...
	@Test(priority = 10)
	public void BluetoothTest() throws InterruptedException 
