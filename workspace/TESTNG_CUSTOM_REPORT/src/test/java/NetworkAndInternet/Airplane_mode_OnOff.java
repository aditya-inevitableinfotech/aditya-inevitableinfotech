 ...
 * </p>
 */
public class Airplane_mode_OnOff implements IReporter {

	AppiumDriver<MobileElement> driver;
    private static final Logger LOG = Logger.getLogger(Airplane_mode_OnOff.class);
	...
	System.out.println("Airplane Mode Testing Started...");
	...
	System.out.println("--------> Airplane Mode Test Executed Successfully on INVi-Tab <--------");
