 ...
 * </p>
 */
public class UseDataSaverbuttonOnOff implements IReporter {
    ...
    private static final Logger LOG = Logger.getLogger(UseDataSaverbuttonOnOff.class);
	...
	@Test(priority = 17)
	public void DataSaverTest() throws InterruptedException
	
	{
	
	System.out.println("Data Saver Testing Started...");
	...
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);Thread.sleep(2000);
	driver.findElementByXPath("//android.widget.TextView[@text='Data Saver']").click();
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);Thread.sleep(2000);
	...
	System.out.println("--------> Data Saver Test Executed Successfully on INVi-Tab <--------");
