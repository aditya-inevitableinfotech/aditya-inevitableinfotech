 ...
 * </p>
 */
public class hawKbitUpdateServerEnd implements IReporter {
	
    private static final Logger LOG = Logger.getLogger(hawKbitUpdateServerEnd.class);
	...
	public void setup() throws MalformedURLException
		...
		caps.setCapability("ChromeDriverExecuable","/home/invlko-026/Downloads/chromedriver");  
	...
	public void hawKbitUpdateServerEndTest() throws InterruptedException, IOException
	{
	
		System.out.println("hawKbit Update Server End Testing Started...");
		System.out.println("I am Trying to run a python Script from here..");

		
		Process p = Runtime.getRuntime().exec("/usr/bin/python /home/invlko-026/Documents/Hawkbit_i500/Auto_Assigne.py");
		...
		System.out.println("Printed from Python");
		
		Process p1 = Runtime.getRuntime().exec("adb shell getprop ro.boot.serialno");
		
		p1.waitFor();
	    BufferedReader briN = new BufferedReader(new InputStreamReader(p1.getInputStream()));
	    String s;
	    
		while ((s = briN.readLine()) != null) {
		System.out.println(s); }
		
		System.out.println("--------> hawKbit Update Server End Test Executed Successfully on INVi-Tab <--------");
