 ...
 * </p>
 */
public class Added_Fdroid_Into_Build implements IReporter {

	AppiumDriver<MobileElement> driver;
    private static final Logger LOG = Logger.getLogger(Added_Fdroid_Into_Build.class);
	...
	public void setup() {
		...
		dc.setCapability("appPackage", "org.fdroid.fdroid");
		dc.setCapability("appActivity", "org.fdroid.fdroid.views.main.MainActivity");
	...
	@Test(priority = 17)
	public void AddedFdroidIntoBuildTest() throws InterruptedException  
	{
		System.out.println("Added Fdroid Into Build Testing is Started...");
		
        driver.findElement(By.xpath("//android.widget.ImageButton[@content-desc='Search']")).click();
        ...
        driver.findElement(By.xpath("//android.widget.TextView[@text='Briar Secure Messaging, Anywhere']")).click();
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);Thread.sleep(5000);
        ...
        System.out.println("---> Added Fdroid Into Build Test Executed Successfully on i300 board <---");
