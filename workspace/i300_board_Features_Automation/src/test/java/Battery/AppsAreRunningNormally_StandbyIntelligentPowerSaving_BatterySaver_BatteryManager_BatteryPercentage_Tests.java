 ...
 * </p>
 */
public class AppsAreRunningNormally_StandbyIntelligentPowerSaving_BatterySaver_BatteryManager_BatteryPercentage_Tests implements IReporter {

	AppiumDriver<MobileElement> driver;
    private static final Logger LOG = Logger.getLogger(AppsAreRunningNormally_StandbyIntelligentPowerSaving_BatterySaver_BatteryManager_BatteryPercentage_Tests.class);
	...
	@Test(priority = 12)
	public void AppsAreRunningNormally_StandbyIntelligentPowerSaving_BatterySaver_BatteryManager_BatteryPercentage_Test() throws InterruptedException
	{
	
	System.out.println("AppsAreRunningNormally_StandbyIntelligentPowerSaving_BatterySaver_BatteryManager_BatteryPercentage_Tests Started...");
	
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);Thread.sleep(2000);
	driver.findElementByXPath("//android.widget.TextView[@text='Battery']").click();
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);Thread.sleep(2000);
	driver.findElementByXPath("//android.widget.TextView[@text='Apps are running normally']").click();
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);Thread.sleep(2000);
	driver.findElementByXPath("//android.widget.Button[@text='OK']").click();
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);Thread.sleep(2000);
	driver.findElementByXPath("//android.widget.TextView[@text='Standby intelligent power saving']").click();
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);Thread.sleep(2000);
	driver.findElementByXPath("//android.widget.TextView[@text='Standby intelligent power saving']").click();
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);Thread.sleep(2000);
	...
	System.out.println("--------> AppsAreRunningNormally_StandbyIntelligentPowerSaving_BatterySaver_BatteryManager_BatteryPercentage_Tests Executed Successfully on i300 board <--------");
