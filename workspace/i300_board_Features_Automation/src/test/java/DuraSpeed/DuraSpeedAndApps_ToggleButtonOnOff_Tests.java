 ...
 * </p>
 */
public class DuraSpeedAndApps_ToggleButtonOnOff_Tests implements IReporter {

	AppiumDriver<MobileElement> driver;
    private static final Logger LOG = Logger.getLogger(DuraSpeedAndApps_ToggleButtonOnOff_Tests.class);
	...
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);Thread.sleep(2000);
	driver.findElementByXPath("//android.widget.TextView[@text='DuraSpeed']").click();
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);Thread.sleep(2000);
	...
	System.out.println("--------> DuraSpeedAndApps_ToggleButtonOnOff_Test Executed Successfully on i300 board <--------");
