 ...
 * </p>
 */
public class MediaVolume_CallVolume_RingAndNotificationVolume_AlarmVolume_Tests implements IReporter {

	AppiumDriver<MobileElement> driver;
    private static final Logger LOG = Logger.getLogger(MediaVolume_CallVolume_RingAndNotificationVolume_AlarmVolume_Tests.class);
	...
	@Test(priority = 14)
	public void MediaVolume_CallVolume_RingAndNotificationVolume_AlarmVolume_Test() throws InterruptedException
	{
	
	System.out.println("MediaVolume_CallVolume_RingAndNotificationVolume_AlarmVolume_Testing Started...");
	...
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);Thread.sleep(10000);
	driver.findElement(By.xpath("//android.widget.TextView[@text='Notification volume']")).click();
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);Thread.sleep(2000);
	...
	System.out.println("--------> MediaVolume_CallVolume_RingAndNotificationVolume_AlarmVolume_Tests Executed Successfully on i300 board <--------");
