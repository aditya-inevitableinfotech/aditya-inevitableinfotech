 ...
 * </p>
 */
public class CapturePictureVideoTest implements IReporter {

	AppiumDriver<MobileElement> driver;
    private static final Logger LOG = Logger.getLogger(CapturePictureVideoTest.class);
	...
	
	{
		...
		driver.findElement(By.id("com.mediatek.camera:id/camera_shutter")).click();
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);Thread.sleep(2000);
		driver.findElement(By.id("com.mediatek.camera:id/shutter_button")).click();
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);Thread.sleep(2000);
		driver.findElement(By.id("com.mediatek.camera:id/shutter_button_video")).click();
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);Thread.sleep(2000);
		driver.findElement(By.id("com.mediatek.camera:id/shutter_button_video")).click();
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);Thread.sleep(2000);
