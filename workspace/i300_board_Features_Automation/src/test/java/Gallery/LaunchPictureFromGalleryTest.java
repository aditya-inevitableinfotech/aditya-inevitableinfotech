 ...
 * </p>
 */
public class LaunchPictureFromGalleryTest implements IReporter {

	AppiumDriver<MobileElement> driver;
    private static final Logger LOG = Logger.getLogger(LaunchPictureFromGalleryTest.class);
	...
	public void setup() {
		...
		dc.setCapability("appPackage", "com.android.gallery3d");
		dc.setCapability("appActivity", "com.android.gallery3d.app.GalleryActivity");
	...
	public void GalleryTest() throws InterruptedException  
	{
		...
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		driver.findElementByXPath("//android.widget.TextView[@text='Select item']").click();
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		driver.findElementByXPath("//android.widget.Button[@text='0 items selected']").click();
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		driver.findElementByXPath("//android.widget.TextView[@text='Select all']").click();
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		driver.findElementByXPath("//android.widget.TextView[@content-desc='Delete']").click();
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		...
		System.out.println("--------> Gallery Test Executed Successfully on i300 board <--------");
