 ...
 * </p>
 */
public class SoundRecordAndPlayTest implements IReporter {

	AppiumDriver<MobileElement> driver;
    private static final Logger LOG = Logger.getLogger(SoundRecordAndPlayTest.class);
	...
	System.out.println("--------> Sound Recorder Test Executed Successfully on i300 board <--------");
