 ...
 * </p>
 */
public class DeviceName_EmergencyInformation_LegalInformation_ModelAndHardware_AndroidVersion_EthernetMACAddress_BluetoothAddress_WiFiMACAddress_CustomBuildVersion_BuildNumber_Tests implements IReporter {

	AppiumDriver<MobileElement> driver;
    private static final Logger LOG = Logger.getLogger(DeviceName_EmergencyInformation_LegalInformation_ModelAndHardware_AndroidVersion_EthernetMACAddress_BluetoothAddress_WiFiMACAddress_CustomBuildVersion_BuildNumber_Tests.class);
	...
	//	dc.setCapability(MobileCapabilityType.UDID,"192.168.18.100:5555");
	...
	@Test(priority = 1)
	public void DeviceName_EmergencyInformation_LegalInformation_ModelAndHardware_AndroidVersion_EthernetMACAddress_BluetoothAddress_WiFiMACAddress_CustomBuildVersion_BuildNumber_Test() throws InterruptedException
	{
	
	System.out.println(" DeviceName_EmergencyInformation_LegalInformation_ModelAndHardware_AndroidVersion_EthernetMACAddress_BluetoothAddress_WiFiMACAddress_CustomBuildVersion_BuildNumber_Tests Started...");
	...
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);Thread.sleep(5000);
	driver.findElementByXPath("//android.widget.TextView[@text='About phone']").click();
	...
	driver.findElementByXPath("//android.widget.Button[@text='OK']").click();
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);Thread.sleep(2000);
	driver.findElementByXPath("//android.widget.TextView[@text='IP address']").click();
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);Thread.sleep(2000);
	driver.findElementByXPath("//android.widget.TextView[@text='Ethernet MAC address']").click();
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);Thread.sleep(2000);
	AndroidElement list1=(AndroidElement)driver.findElementById("android:id/title");
	MobileElement listitem1 = (MobileElement)driver.findElement(MobileBy.AndroidUIAutomator("new UiScrollable(new UiSelector()).scrollIntoView("+"new UiSelector().text(\"Custom build version\"));"));
	System.out.println(listitem1.getLocation());listitem1.click();
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);Thread.sleep(2000);
	...
	System.out.println("--------> DeviceName_EmergencyInformation_LegalInformation_ModelAndHardware_AndroidVersion_EthernetMACAddress_BluetoothAddress_WiFiMACAddress_CustomBuildVersion_BuildNumber_Tests Executed Successfully on i300 board <--------");
