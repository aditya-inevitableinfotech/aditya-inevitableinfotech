 ...
 * </p>
 */
public class AddedVanadiumIntoBuild_AlphaNumericPassWithUppercaseLowercaseSymbol_WipeUserDataOnTooManyAttempts_AddPermissionForFormatDeviceAtLockScreen implements IReporter {

	AppiumDriver<MobileElement> driver;
    private static final Logger LOG = Logger.getLogger(AddedVanadiumIntoBuild_AlphaNumericPassWithUppercaseLowercaseSymbol_WipeUserDataOnTooManyAttempts_AddPermissionForFormatDeviceAtLockScreen.class);
	...
	public void setup() {
		...
		dc.setCapability("appPackage", "org.chromium.chrome");
		dc.setCapability("appActivity", "com.google.android.apps.chrome.Main");
		
		
		URL url = new URL("http://127.0.0.1:4723/wd/hub");
		driver = new AndroidDriver<MobileElement>(url, dc);
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.MINUTES);Thread.sleep(10000);
	...
	@Test(priority = 17)
	public void  AddedVanadiumIntoBuild_AlphaNumericPassWithUppercaseLowercaseSymbol_WipeUserDataOnTooManyAttempts_AddPermissionForFormatDeviceAtLockScreen_Test() throws InterruptedException 
	
	{		

		System.out.println(" AddedVanadiumIntoBuild_AlphaNumericPassWithUppercaseLowercaseSymbol_WipeUserDataOnTooManyAttempts_AddPermissionForFormatDeviceAtLockScreen Testing is Started...");
		
		driver.get("http://122.166.188.93:3001/login");
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.MINUTES);Thread.sleep(20000);
	    driver.findElement(By.xpath("//android.widget.ImageButton[@content-desc='Home']")).click();
	    driver.manage().timeouts().implicitlyWait(10, TimeUnit.MINUTES);Thread.sleep(5000);
		...
		driver.findElement(By.xpath("//android.widget.EditText[@content-desc='Device password']")).sendKeys("Ad2@");
        ...
        System.out.println("--->  AddedVanadiumIntoBuild_AlphaNumericPassWithUppercaseLowercaseSymbol_WipeUserDataOnTooManyAttempts_AddPermissionForFormatDeviceAtLockScreen Test Executed Successfully on i300 board <---");
